// static/js/four_kind_chart.js
// Requires Chart.js loaded before this script.

(function () {
  const CANVAS_ID = 'fourKindChart';
  const API_URL_BASE = '/api/four_kind_minutes';
  ...
  function createLineChart(ctx, labels, counts) {
    return new Chart(ctx, {
      ...
      data: {
        labels: labels,
        datasets: [{
          label: 'Tổng số lần nổ Tứ quý',
          data: counts,
          borderColor: 'rgba(201,42,42,0.95)',
  ...
  window.refreshFourKindChart = function (agg = 1) {
